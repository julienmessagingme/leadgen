...
var DEFAULT_EMAIL_FOLLOWUP_TEMPLATE =
  ...
  "3. CITER TOUS LES CAS FOURNIS — INTERDICTION TOTALE D INVENTER UN CLIENT : des cas peuvent etre fournis via 'Cas client a citer' ET 'Cas clients supplementaires a citer si pertinents'.\n" +
  "   — Si PLUSIEURS cas sont fournis, cite-les TOUS (pas juste le 1er) — pour chaque : nom + chiffre + 1 phrase de lien avec le conversationnel.\n" +
  "   — Si AUCUN cas n est fourni : tu n as AUCUN droit de citer un nom d entreprise/marque comme reference client, meme du secteur du prospect, meme avec 'on voit que' ou 'comme'. Pas de 'Hermes a fait', 'Axa utilise', 'Sephora a deploye'. Pas de chiffres precis. Parle en tendance sectorielle generique : 'les assureurs observent', 'dans le luxe on voit', sans exemple nomme.\n" +
  "   Test mental : si le nom de la marque n est PAS litteralement present dans le contexte, tu ne l ecris pas. Meme une fois.\n" +
